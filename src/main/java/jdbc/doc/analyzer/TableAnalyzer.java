...
public class TableAnalyzer {
    ...
    public List<Table> getTableData() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                tables.add(createTableRepresentation(tableName));
            }
            resultSet.close();
    ...
    private Table createTableRepresentation(String tableName) {
        List<Column> columns = columnAnalyzer.getTableColumns(tableName);
        String primaryKeyName = primaryKeyAnalyzer.identifyPrimaryKey(tableName, columns);
        referenceAnalyzer.analyzeTableReferences(tableName, columns);
        List<Index> indices = indexAnalyzer.getTableIndices(tableName);
